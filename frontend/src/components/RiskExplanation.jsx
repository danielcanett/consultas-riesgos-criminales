...
export default function RiskExplanationTabs({ results }) {
  ...
  React.useEffect(() => {
    console.log('RiskExplanation - Results recibidos:', results);
    if (results) {
      console.log('Formulas:', results.formulas ? 'SÍ' : 'NO');
      console.log('Sources:', results.sources ? 'SÍ' : 'NO');
      console.log('Theories:', results.theories ? 'SÍ' : 'NO');
    }
  }, [results]);
          ...
          <CardContent>
            ...
            <Box sx={{ backgroundColor: "#f8f9fa", p: 2, borderRadius: 1, mb: 2 }}>
              {results && results.formulas ? 
                processTextWithLinks(results.formulas) : 
        ...
        <Card elevation={3} sx={{ mb: 2 }}>
          <CardContent>
            ...
            <Box sx={{ backgroundColor: "#f8f9fa", p: 2, borderRadius: 1 }}>
              {results && results.theories ? 
                processTextWithLinks(results.theories) : 
